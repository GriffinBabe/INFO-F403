...
class Main {
	...
	/**
	 * Entry point. Checks if a source file is specified in the program arguments, then initializes a {@link Main}
	 * objects. Finally it calls the {@link Main#printTable()} function.
