...
/**
 * CompilerSymbol class is the base class that represents all the program instructions to be compiled.
 *
 * Final LLVM code is generated by calling the {@link #toLLVM(CompilerTable, TempVariable...)} method to the program's root
 * {@link CompilerSymbol}, generally a {@link ProgramSymbol}.
 */
public abstract class CompilerSymbol {
     ...
     * @param returnRegisters
     * @return the final LLVM source code of this symbol and children symbols.
     */
    public abstract String toLLVM(CompilerTable table, TempVariable... returnRegisters);
